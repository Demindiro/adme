...
enum IrOp {
	...
	Nor { dst: u8, a: u8, b: u8 },
	Xor { dst: u8, a: u8, b: u8 },
	Mulu { hi: u8, lo: u8, a: u8, b: u8 },
	Muls { hi: u8, lo: u8, a: u8, b: u8 },
	Divu { quot: u8, rem: u8, a: u8, b: u8 },
	Divs { quot: u8, rem: u8, a: u8, b: u8 },
	Sl { dst: u8, a: u8, b: u8 },
	Srl { dst: u8, a: u8, b: u8 },
	Sra { dst: u8, a: u8, b: u8 },
	Slts { dst: u8, a: u8, b: u8 },
	Sltu { dst: u8, a: u8, b: u8 },
	Sltis { dst: u8, a: u8, imm: isize },
	Sltiu { dst: u8, a: u8, imm: usize },
	Sli { dst: u8, a: u8, imm: usize },
	Srli { dst: u8, a: u8, imm: usize },
	Srai { dst: u8, a: u8, imm: usize },
	Addi { dst: u8, a: u8, imm: isize },
	Andi { dst: u8, a: u8, imm: usize },
	Ori { dst: u8, a: u8, imm: usize },
	Xori { dst: u8, a: u8, imm: usize },
	J { location: usize },
	Jal { link: u8, location: usize },
	Jr { register: u8 },
	Jalr { link: u8, register: u8 },
	Ble { a: u8, b: u8, location: usize },
	Bgt { a: u8, b: u8, location: usize },
	Beq { a: u8, b: u8, location: usize },
	Bne { a: u8, b: u8, location: usize },
	Lu8 { reg: u8, mem: u8, offset: isize },
	Li8 { reg: u8, mem: u8, offset: isize },
	Lu16 { reg: u8, mem: u8, offset: isize },
	Li16 { reg: u8, mem: u8, offset: isize },
	Lu32 { reg: u8, mem: u8, offset: isize },
	S8 { reg: u8, mem: u8, offset: isize },
	S16 { reg: u8, mem: u8, offset: isize },
	S32 { reg: u8, mem: u8, offset: isize },
	Syscall,
	InvalidOp,
}
...
impl Jit {
	...
	pub fn push(&mut self, instr: u32) {
		if let Ok(op) = Op::try_from(instr) {
			...
			let ops = match op {
				...
				// TODO: check for overflow
				Op::Addi => (
					IrOp::Addi { dst: i.t, a: i.s, imm: (i.imm_i16() as isize) },
					None,
				),
				Op::Addiu => (
					IrOp::Addi { dst: i.t, a: i.s, imm: (i.imm_i16() as isize) },
				...
				Op::Andi => (IrOp::Andi { dst: i.t, a: i.s, imm: i.imm.into() }, None),
				Op::Ori => (IrOp::Ori { dst: i.t, a: i.s, imm: i.imm.into() }, None),
				Op::Xori => (IrOp::Xori { dst: i.t, a: i.s, imm: i.imm.into() }, None),
				Op::Slti => (
					IrOp::Sltis { dst: i.t, a: i.s, imm: i.imm_i16().into() },
					None,
				),
				Op::Sltiu => (IrOp::Sltiu { dst: i.t, a: i.s, imm: i.imm.into() }, None),
				Op::Beq => {
				...
				Op::Lui => (
					IrOp::Ori { dst: i.t, a: 0, imm: usize::from(i.imm) << 16 },
					None,
				),
				Op::Lhi => (
				...
				Op::Lb => (
					IrOp::Li8 { reg: i.t, mem: i.s, offset: i.imm_i16().into() },
					None,
				),
				Op::Lbu => (
					IrOp::Lu8 { reg: i.t, mem: i.s, offset: i.imm_i16().into() },
					None,
				),
				Op::Lh => (
					IrOp::Li16 { reg: i.t, mem: i.s, offset: i.imm_i16().into() },
					None,
				),
				Op::Lhu => (
					IrOp::Lu16 { reg: i.t, mem: i.s, offset: i.imm_i16().into() },
					None,
				),
				Op::Lw => (
					IrOp::Lu32 { reg: i.t, mem: i.s, offset: i.imm_i16().into() },
					None,
				),
				Op::Sb => (
					IrOp::S8 { reg: i.t, mem: i.s, offset: i.imm_i16().into() },
					None,
				),
				Op::Sh => (
					IrOp::S16 { reg: i.t, mem: i.s, offset: i.imm_i16().into() },
					None,
				),
				Op::Sw => (
					IrOp::S32 { reg: i.t, mem: i.s, offset: i.imm_i16().into() },
					None,
				),
				Op::J => {
	...
	pub fn finish(self) -> x86_64::Executable {
			...
			.enumerate()
		{
			dbg!(self.ir[*loc - 1]);
			match &self.ir[*loc - 1] {
				IrOp::J { location } | IrOp::Jal { location, .. } => {
					// Link to one block
